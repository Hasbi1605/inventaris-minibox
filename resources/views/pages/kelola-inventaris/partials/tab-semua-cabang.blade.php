<div id="content-cabang-semua-cabang" class="cabang-content">
        ...
        @else
            ...
            <div class="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border border border-gray-100">
                <div class="flex-auto p-4">
                    <div class="flex flex-row items-center">
                        <div class="flex-shrink-0">
                            <div class="inline-flex items-center justify-center w-12 h-12 text-center rounded-xl bg-gradient-to-tl from-yellow-600 to-orange-400 shadow-soft-md">
    ...
    <!-- Table -->
    <div class="relative flex flex-col min-w-0 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-board mb-6">
        <div class="p-6 pb-0 mb-0 bg-white border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
            <h6 class="font-bold">Daftar Inventaris - Semua Cabang</h6>
        </div>
            ...
            <div class="p-0 overflow-x-auto">
                <table class="items-center w-full mb-0 align-top border-gray-200 text-slate-500">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                <span class="text-xs font-semibold leading-tight text-slate-600">
                                    <i class="fas fa-store mr-1"></i>{{ $item->cabang->nama_cabang ?? '-' }}
                                </span>
                            </td>
                            <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                        ...
                        @empty
                        <tr>
                            <td colspan="7" class="p-6 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                <div class="py-8">
                                    <i class="fas fa-boxes text-4xl text-slate-300 mb-4"></i>
                                    <p class="text-slate-500 mb-2">Belum ada data inventaris.</p>
