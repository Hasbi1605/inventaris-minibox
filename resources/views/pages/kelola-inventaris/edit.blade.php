        ...
        <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
            <div class="p-6 pb-0 mb-0 bg-white rounded-t-2xl">
                <div class="flex justify-between items-center">
                    <h6 class="mb-0 text-slate-700">Edit Inventaris: {{ $inventaris->nama_barang }}</h6>
                ...
                <form action="{{ route('kelola-inventaris.update', $inventaris->id) }}" method="POST">
                    ...
                    <div class="flex flex-wrap -mx-3">
                        ...
                        <div class="w-full max-w-full px-3 mb-4 md:w-1/2 md:flex-none">
                            ...
                            <select name="kategori" 
                                ...
                                @foreach($categories as $category)
                                    <option value="{{ $category }}" {{ old('kategori', $inventaris->kategori) == $category ? 'selected' : '' }}>
                                        {{ $category }}
                                    </option>
                                @endforeach
                                <option value="Peralatan Cukur" {{ old('kategori', $inventaris->kategori) == 'Peralatan Cukur' ? 'selected' : '' }}>Peralatan Cukur</option>
                                <option value="Produk Perawatan" {{ old('kategori', $inventaris->kategori) == 'Produk Perawatan' ? 'selected' : '' }}>Produk Perawatan</option>
                                <option value="Peralatan Salon" {{ old('kategori', $inventaris->kategori) == 'Peralatan Salon' ? 'selected' : '' }}>Peralatan Salon</option>
                                <option value="Bahan Kimia" {{ old('kategori', $inventaris->kategori) == 'Bahan Kimia' ? 'selected' : '' }}>Bahan Kimia</option>
                                <option value="Aksesoris" {{ old('kategori', $inventaris->kategori) == 'Aksesoris' ? 'selected' : '' }}>Aksesoris</option>
                        ...
                        <div class="w-full max-w-full px-3 mb-4 md:w-1/2 md:flex-none">
                            ...
                            <input type="text" name="merek" value="{{ old('merek', $inventaris->merek) }}" 
                        ...
                        <div class="w-full max-w-full px-3 mb-4 md:w-1/3 md:flex-none">
                            ...
                            <input type="number" name="stok_minimal" value="{{ old('stok_minimal', $inventaris->stok_minimal) }}" min="0"
                        ...
                        <div class="w-full max-w-full px-3 mb-4 md:w-1/3 md:flex-none">
                            ...
                            <input type="number" name="stok_saat_ini" value="{{ old('stok_saat_ini', $inventaris->stok_saat_ini) }}" min="0"
                        ...
                        <div class="w-full max-w-full px-3 mb-4 md:w-1/3 md:flex-none">
                            ...
                            <input type="number" name="harga_satuan" value="{{ old('harga_satuan', $inventaris->harga_satuan) }}" min="0" step="0.01"
                        ...
                        <div class="w-full max-w-full px-3 mb-4 md:w-1/2 md:flex-none">
                            ...
                            <input type="date" name="tanggal_kadaluarsa" value="{{ old('tanggal_kadaluarsa', $inventaris->tanggal_kadaluarsa ? $inventaris->tanggal_kadaluarsa->format('Y-m-d') : '') }}"
