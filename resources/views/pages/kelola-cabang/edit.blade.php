...
<div class="w-full max-w-full min-h-screen">
    ...
    <div class="flex flex-wrap items-center justify-between mb-6">
        <div>
            <h4 class="mb-0 font-bold text-slate-700">Edit Cabang</h4>
            <p class="mb-0 text-sm text-slate-500">Perbarui informasi cabang: {{ $cabang->nama_cabang }}</p>
        </div>
        <div class="flex space-x-2">
            <a href="{{ route('kelola-cabang.show', $cabang->id) }}" 
        ...
        <div class="flex-none w-full max-w-full px-3">
            <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
                <div class="p-6 pb-0 mb-0 bg-white border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                    <h6 class="font-bold">Form Edit Cabang</h6>
                    <p class="text-sm leading-normal text-slate-400">Perbarui informasi cabang di bawah ini</p>
                </div>
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input 
                                    ...
                                    name="tanggal_buka" 
                                    id="tanggal_buka"
                                    value="{{ old('tanggal_buka', $cabang->tanggal_buka->format('Y-m-d')) }}"
                                    max="{{ date('Y-m-d') }}"
