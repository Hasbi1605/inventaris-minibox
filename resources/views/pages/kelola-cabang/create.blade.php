        ...
        <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
            <div class="p-6 pb-0 mb-0 bg-white rounded-t-2xl">
                <div class="flex justify-between items-center">
                    <h6 class="mb-0 text-slate-700">Tambah Cabang Baru</h6>
                ...
                <form action="{{ route('kelola-cabang.store') }}" method="POST">
                    ...
                    <div class="flex flex-wrap -mx-3">
                        ...
                        <div class="w-full max-w-full px-3 mb-4 md:w-1/2 md:flex-none">
                            ...
                            <input type="text" name="manager" value="{{ old('manager') }}" placeholder="Nama lengkap manager cabang" class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:outline-none focus:transition-shadow @error('manager') border-red-300 @enderror" required>
                            @error('manager')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="w-full max-w-full px-3 mb-4 md:w-1/2 md:flex-none">
                            ...
                            <input type="tel" name="telepon" value="{{ old('telepon') }}" placeholder="021-12345678" class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:outline-none focus:transition-shadow @error('telepon') border-red-300 @enderror" required>
                            @error('telepon')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="w-full max-w-full px-3 mb-4 md:w-1/2 md:flex-none">
                            ...
                            <input type="email" name="email" value="{{ old('email') }}" placeholder="cabang@barbershop.com" class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:outline-none focus:transition-shadow @error('email') border-red-300 @enderror">
                            @error('email')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="w-full max-w-full px-3 mb-4 md:w-1/3 md:flex-none">
                            ...
                            <input type="date" name="tanggal_buka" value="{{ old('tanggal_buka', date('Y-m-d')) }}" max="{{ date('Y-m-d') }}" class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:outline-none focus:transition-shadow @error('tanggal_buka') border-red-300 @enderror" required>
                            @error('tanggal_buka')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <!-- Spacer -->
                        <div class="w-full max-w-full px-3 mb-4 md:w-1/3 md:flex-none"></div>

                        <!-- Jam Operasional Buka -->
                        <div class="w-full max-w-full px-3 mb-4 md:w-1/2 md:flex-none">
                            <label class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700">Jam Buka (Opsional)</label>
                            <input type="time" name="jam_operasional_buka" value="{{ old('jam_operasional_buka', '09:00') }}" class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:outline-none focus:transition-shadow @error('jam_operasional_buka') border-red-300 @enderror">
                        ...
                        <div class="w-full max-w-full px-3 mb-4 md:w-1/2 md:flex-none">
                            ...
                            <input type="time" name="jam_operasional_tutup" value="{{ old('jam_operasional_tutup', '21:00') }}" class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:outline-none focus:transition-shadow @error('jam_operasional_tutup') border-red-300 @enderror">
