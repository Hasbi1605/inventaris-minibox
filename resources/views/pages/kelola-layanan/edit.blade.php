        ...
        <div class="flex-none w-full max-w-full px-3">
            <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
                ...
                <div class="flex-auto px-6 pt-0 pb-6">
                    <form action="{{ route('kelola-layanan.update', $layanan->id) }}" method="POST" id="layanan-form">
                        @csrf
                        @method('PUT')
                                        ...
                                        <div class="flex items-start p-3 bg-white border border-gray-200 rounded-lg hover:border-blue-300 transition-all">
                                            ...
                                            <div class="ml-3 flex-1">
                                                ...
                                                <div id="harga_container_{{ $cabang->id }}" class="mt-3 {{ $isChecked ? '' : 'hidden' }}">
                                                    ...
                                                    <input type="hidden" name="harga_cabang[{{ $cabang->id }}]" id="harga_cabang_{{ $cabang->id }}" value="{{ $hargaCabang }}">
                                                </div>
                                            </div>
                                        </div>
                                        @endforeach
