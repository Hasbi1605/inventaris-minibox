                            ...
                            <div>
                                ...
                                >
                                    ...
                                    @foreach($layanan as $service)
                                        ...
                                        @endphp
                                        <option value="{{ $service->id }}" data-harga="{{ $hargaToShow }}" {{ old('layanan_id') == $service->id ? 'selected' : '' }}>
                            ...
                            <div class="col-span-1 lg:col-span-2" id="produkSection">
                                <div class="flex items-center justify-between mb-2">
                                    ...
                                    <div class="flex gap-2">
                                        ...
                                        <button type="button" 
                                            id="addProduk"
                                            class="inline-block px-4 py-2 font-bold text-center text-white uppercase align-middle transition-all rounded-lg cursor-pointer bg-gradient-to-tl from-green-600 to-lime-400 leading-pro text-xs ease-soft-in tracking-tight-soft shadow-soft-md bg-150 bg-x-25 hover:scale-102 active:opacity-85 hover:shadow-soft-xs">
