        ...
        <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
            <div class="p-6 pb-0 mb-0 bg-white rounded-t-2xl">
                <div class="flex justify-between items-center">
                    <h6 class="mb-0 text-slate-700">Edit Transaksi: {{ $transaksi->nomor_transaksi }}</h6>
                ...
                <form action="{{ route('kelola-transaksi.update', $transaksi->id) }}" method="POST">
                    ...
                    <div class="flex flex-wrap -mx-3">
                        ...
                        <div class="w-full max-w-full px-3 mb-4 md:w-1/2 md:flex-none">
                            ...
                            <input type="text" name="telepon_pelanggan" value="{{ old('telepon_pelanggan', $transaksi->telepon_pelanggan) }}" 
                        ...
                        <div class="w-full max-w-full px-3 mb-4 md:w-1/2 md:flex-none">
                            ...
                            <input type="number" name="total_harga" id="total_harga" value="{{ old('total_harga', $transaksi->total_harga) }}" min="0" step="0.01"
                        ...
                        <div class="w-full max-w-full px-3 mb-4 md:w-1/3 md:flex-none">
                            ...
                            <input type="date" name="tanggal_transaksi" value="{{ old('tanggal_transaksi', $transaksi->tanggal_transaksi->format('Y-m-d')) }}"
                        ...
                        <div class="w-full max-w-full px-3 mb-4 md:w-1/3 md:flex-none">
                            ...
                            <input type="time" name="waktu_mulai" value="{{ old('waktu_mulai', $transaksi->waktu_mulai) }}"
                        ...
                        <div class="w-full max-w-full px-3 mb-4 md:w-1/3 md:flex-none">
                            ...
                            <input type="time" name="waktu_selesai" value="{{ old('waktu_selesai', $transaksi->waktu_selesai) }}"
                        ...
                        <div class="w-full max-w-full px-3 mb-4">
                            ...
                            <textarea name="catatan" rows="4" 
                                ...
                                placeholder="Masukkan catatan tambahan (opsional)">{{ old('catatan', $transaksi->catatan) }}</textarea>
                            @error('catatan')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
