...
@section('page-title', 'Edit Kapster')
...
<div class="w-full max-w-full min-h-screen">
    ...
    <div class="flex flex-wrap items-center justify-between mb-6">
        <div>
            <h4 class="mb-0 font-bold text-slate-700">Edit Kapster</h4>
            <p class="mb-0 text-sm text-slate-500">Perbarui data kapster {{ $kelola_kapster->nama_kapster }}</p>
        </div>
        <div>
        ...
        <div class="flex-none w-full max-w-full px-3">
            <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
                <div class="p-6 pb-0 mb-0 bg-white border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                    <h6 class="font-bold">Form Edit Kapster</h6>
                    <p class="text-sm leading-normal text-slate-400">Perbarui informasi kapster di bawah ini</p>
                </div>
                <div class="flex-auto px-6 pt-0 pb-6">
                    <form action="{{ route('kelola-kapster.update', $kelola_kapster->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div class="col-span-1 lg:col-span-2">
                                ...
                                <input 
                                    ...
                                    name="nama_kapster" 
                                    id="nama_kapster"
                                    value="{{ old('nama_kapster', $kelola_kapster->nama_kapster) }}"
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    @foreach($cabang as $item)
                                        <option value="{{ $item->id }}" {{ old('cabang_id', $kelola_kapster->cabang_id) == $item->id ? 'selected' : '' }}>
                                            {{ $item->nama_cabang }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    @foreach($statusOptions as $key => $value)
                                        <option value="{{ $key }}" {{ old('status', $kelola_kapster->status) == $key ? 'selected' : '' }}>{{ $value }}</option>
                                    @endforeach
                                </select>
                                @error('status')
                                    <div class="text-xs text-red-500 mt-1">{{ $message }}</div>
                            ...
                            <div>
                                ...
                                <input 
                                    ...
                                    name="spesialisasi" 
                                    id="spesialisasi"
                                    value="{{ old('spesialisasi', $kelola_kapster->spesialisasi) }}"
                            ...
                            <div>
                                ...
                                <input 
                                    ...
                                    name="telepon" 
                                    id="telepon"
                                    value="{{ old('telepon', $kelola_kapster->telepon) }}"
                                        ...
                                        <div>
                                            ...
                                            <div class="flex">
                                                <input 
                                                    ...
                                                    value="{{ old('komisi_potong_rambut', $kelola_kapster->komisi_potong_rambut ?? 40) }}"
                                        ...
                                        <div>
                                            ...
                                            <div class="flex">
                                                <input 
                                                    ...
                                                    value="{{ old('komisi_layanan_lain', $kelola_kapster->komisi_layanan_lain ?? 25) }}"
                                        ...
                                        <div>
                                            ...
                                            <div class="flex">
                                                <input 
                                                    ...
                                                    name="komisi_produk" 
                                                    id="komisi_produk"
                                                    value="{{ old('komisi_produk', $kelola_kapster->komisi_produk ?? 25) }}"
