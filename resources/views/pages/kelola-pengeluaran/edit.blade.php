...
<div class="w-full max-w-full min-h-screen">
    ...
    <div class="flex flex-wrap items-center justify-between mb-6">
        <div>
            <h4 class="mb-0 font-bold text-slate-700">Edit Pengeluaran</h4>
            <p class="mb-0 text-sm text-slate-500">Perbarui catatan pengeluaran</p>
        </div>
        <div class="flex space-x-2">
            <a href="{{ route('kelola-pengeluaran.show', $pengeluaran->id) }}" 
        ...
        <div class="flex-none w-full max-w-full px-3">
            <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
                <div class="p-6 pb-0 mb-0 bg-white border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                    <h6 class="font-bold">Form Edit Pengeluaran</h6>
                    <p class="text-sm leading-normal text-slate-400">Perbarui informasi pengeluaran di bawah ini</p>
                </div>
                <div class="flex-auto px-6 pt-0 pb-6">
                    <form action="{{ route('kelola-pengeluaran.update', $pengeluaran->id) }}" method="POST" id="pengeluaran-form">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-4">
                            ...
                            <div class="col-span-1 lg:col-span-2">
                                ...
                                <input 
                                    ...
                                    name="deskripsi" 
                                    id="deskripsi"
                                    value="{{ old('deskripsi', $pengeluaran->nama_pengeluaran) }}"
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    @foreach($categories as $id => $nama)
                                        <option value="{{ $id }}" {{ old('kategori_id', $pengeluaran->kategori_id) == $id ? 'selected' : '' }}>{{ $nama }}</option>
                                    @endforeach
                                </select>
