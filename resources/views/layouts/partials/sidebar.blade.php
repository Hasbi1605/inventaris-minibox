...
<aside id="sidenav-main" class="max-w-62.5 ease-nav-brand z-990 fixed inset-y-0 my-4 ml-4 block w-full -translate-x-full flex-wrap items-center justify-between overflow-y-auto rounded-2xl border-0 bg-white p-0 antialiased shadow-none transition-all duration-300 xl:left-0 xl:translate-x-0 xl:bg-transparent sidebar-expanded">
    ...
    <div class="items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full">
        <ul class="flex flex-col pl-0 mb-0">
            ...
            <!-- Tables -->
            <li class="mt-0.5 w-full relative">
                <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg px-4 transition-all duration-200 {{ request()->routeIs('tables') ? 'bg-white shadow-soft-xl font-semibold text-slate-700' : 'hover:bg-white/10' }}" href="{{ route('tables') }}">
                    <div class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5 {{ request()->routeIs('tables') ? 'bg-gradient-to-tl from-green-600 to-lime-400 shadow-soft-2xl' : 'bg-white' }}">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>office</title>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g transform="translate(-1869.000000, -293.000000)" fill="{{ request()->routeIs('tables') ? '#FFFFFF' : '#1f2937' }}" fill-rule="nonzero">
                                    <g transform="translate(1716.000000, 291.000000)">
                    ...
                    <span class="sidebar-text ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Tables</span>
                    <div class="sidebar-tooltip">Tables</div>
                </a>
            </li>

            <!-- Billing -->
            <li class="mt-0.5 w-full relative">
                <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg px-4 transition-all duration-200 {{ request()->routeIs('billing') ? 'bg-white shadow-soft-xl font-semibold text-slate-700' : 'hover:bg-white/10' }}" href="{{ route('billing') }}">
                    <div class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5 {{ request()->routeIs('billing') ? 'bg-gradient-to-tl from-green-600 to-lime-400 shadow-soft-2xl' : 'bg-white' }}">
                        <svg width="12px" height="12px" viewBox="0 0 43 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>credit-card</title>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g transform="translate(-2169.000000, -745.000000)" fill="{{ request()->routeIs('billing') ? '#FFFFFF' : '#1f2937' }}" fill-rule="nonzero">
                                    <g transform="translate(1716.000000, 291.000000)">
                    ...
                    <span class="sidebar-text ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Billing</span>
            ...
            <!-- Virtual Reality -->
            <li class="mt-0.5 w-full relative">
                <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg px-4 transition-all duration-200 {{ request()->routeIs('virtual-reality') ? 'bg-white shadow-soft-xl font-semibold text-slate-700' : 'hover:bg-white/10' }}" href="{{ route('virtual-reality') }}">
                    <div class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5 {{ request()->routeIs('virtual-reality') ? 'bg-gradient-to-tl from-green-600 to-lime-400 shadow-soft-2xl' : 'bg-white' }}">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>box-3d-50</title>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g transform="translate(-2319.000000, -291.000000)" fill="{{ request()->routeIs('virtual-reality') ? '#FFFFFF' : '#1f2937' }}" fill-rule="nonzero">
                                    <g transform="translate(1716.000000, 291.000000)">
                    ...
                    <span class="sidebar-text ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Virtual Reality</span>
                    <div class="sidebar-tooltip">Virtual Reality</div>
                </a>
            </li>

            <!-- RTL -->
            <li class="mt-0.5 w-full relative">
                <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg px-4 transition-all duration-200 {{ request()->routeIs('rtl') ? 'bg-white shadow-soft-xl font-semibold text-slate-700' : 'hover:bg-white/10' }}" href="{{ route('rtl') }}">
                    <div class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5 {{ request()->routeIs('rtl') ? 'bg-gradient-to-tl from-green-600 to-lime-400 shadow-soft-2xl' : 'bg-white' }}">
                        <svg width="12px" height="12px" viewBox="0 0 40 44" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>settings</title>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g transform="translate(-2020.000000, -442.000000)" fill="{{ request()->routeIs('rtl') ? '#FFFFFF' : '#1f2937' }}" fill-rule="nonzero">
                                    <g transform="translate(1716.000000, 291.000000)">
                    ...
                    <span class="sidebar-text ml-1 duration-300 opacity-100 pointer-events-none ease-soft">RTL</span>
                    <div class="sidebar-tooltip">RTL</div>
                </a>
            </li>

            <!-- Profile -->
            <li class="mt-0.5 w-full relative">
                <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg px-4 transition-all duration-200 {{ request()->routeIs('profile') ? 'bg-white shadow-soft-xl font-semibold text-slate-700' : 'hover:bg-white/10' }}" href="{{ route('profile') }}">
                    <div class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5 {{ request()->routeIs('profile') ? 'bg-gradient-to-tl from-green-600 to-lime-400 shadow-soft-2xl' : 'bg-white' }}">
                        <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>customer-support</title>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g transform="translate(-1717.000000, -291.000000)" fill="{{ request()->routeIs('profile') ? '#FFFFFF' : '#1f2937' }}" fill-rule="nonzero">
                                    <g transform="translate(1716.000000, 291.000000)">
                    ...
                    <span class="sidebar-text ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Profile</span>
